...
if __name__ == "__main__":
	try:
		...
		accounts = node.create_accounts(4, "20.0000 PXBTS")
		node.run_node()	
		#Changeparams
		...
		summary.user_block_status(node, accounts[1].name, ResourceResult(_balance="20.0000 PXBTS",_net_weight="91780400.7844 BEOS",_cpu_weight="91780400.7845 BEOS",_ram_bytes=1599620448))
		summary.user_block_status(node, accounts[2].name, ResourceResult(_balance="20.0000 PXBTS",_net_weight="91780400.7844 BEOS",_cpu_weight="91780400.7845 BEOS",_ram_bytes=1599620448))
		summary.user_block_status(node, accounts[3].name, ResourceResult(_balance="20.0000 PXBTS",_net_weight="91780400.7844 BEOS",_cpu_weight="91780400.7845 BEOS",_ram_bytes=1599620448))
		...
		summary.user_block_status(node, accounts[3].name, ResourceResult(_balance="20.0000 PXBTS",_net_weight="214154268.4970 BEOS",_cpu_weight="214154268.4972 BEOS",_ram_bytes=3732440448))
		node.wait_till_block(56)
		summary.user_block_status(node, accounts[2].name, ResourceResult(_balance="20.0000 PXBTS",_net_weight="214154268.4970 BEOS",_cpu_weight="214154268.4972 BEOS",_ram_bytes=3732440448))
		node.wait_till_block(70)
		summary.action_status(node.withdraw(_from=accounts[2].name,_bts_to="any_account",_quantity="20.0000 PXBTS",_memo="") )
		...
		summary.user_block_status(node, accounts[3].name, ResourceResult(_balance="20.0000 PXBTS",_net_weight="397715070.0660 BEOS",_cpu_weight="397715070.0662 BEOS",_ram_bytes=6931670448))
		node.wait_till_block(82)
		summary.user_block_status(node, accounts[1].name, ResourceResult(_balance="",_net_weight="214154268.4970 BEOS",_cpu_weight="214154268.4972 BEOS",_ram_bytes=3732440448))
		summary.action_status(node.withdraw(_from=accounts[3].name,_bts_to="any_account",_quantity="20.0000 PXBTS",_memo="") )
		summary.user_block_status(node, accounts[2].name, ResourceResult(_balance="",_net_weight="397715070.0660 BEOS",_cpu_weight="397715070.0662 BEOS",_ram_bytes=6931670448))
		summary.user_block_status(node, accounts[0].name, ResourceResult(_balance="",_net_weight="91780400.7844 BEOS",_cpu_weight="91780400.7845 BEOS",_ram_bytes=1599620448))
