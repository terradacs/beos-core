...
if __name__ == "__main__":
	try:
		...
		summary.action_status(node.withdraw(_from=producers[0].name,_bts_to="any_account",_quantity="5.0000 PXBTS",_memo="_memo") )
		summary.action_status(node.withdraw(_from=producers[1].name,_bts_to="any_account",_quantity="5.0000 PXBTS",_memo="_memo") )
