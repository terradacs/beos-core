...
if __name__ == "__main__":
	try:
		...
		summary.user_block_status(node, producers[1].name, ResourceResult(_balance="",_net_weight="917804157.8448 BEOS",_cpu_weight="917804157.8450 BEOS",_ram_bytes=15998155448))
		summary.user_block_status(node, producers[2].name, ResourceResult(_balance="",_net_weight="0.0000 BEOS",_cpu_weight="0.0000 BEOS",_ram_bytes=5448))
