...
if __name__ == "__main__":
	try:
		...
		info = Info( is_creation, accounts, nr_accounts, is_reg_producer, is_vote_producer )
		...
		what = "Incorrect number of producents: rpc: %s created: %s \n" % ( rpc_nr_producers, nr_accounts + nr_system_producers + 1 )
		summary.equal( rpc_nr_producers, nr_accounts + nr_system_producers + 1, what )
