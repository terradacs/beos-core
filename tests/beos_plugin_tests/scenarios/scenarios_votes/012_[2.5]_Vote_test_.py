...
if __name__ == "__main__":
	try:
		...
		summary.user_block_status(node, producers[0].name, ResourceResult(_balance="10.0000 PXBTS",_net_weight="1835608315.6898 BEOS",_cpu_weight="1835608315.6898 BEOS",_ram_bytes=31996305448))
