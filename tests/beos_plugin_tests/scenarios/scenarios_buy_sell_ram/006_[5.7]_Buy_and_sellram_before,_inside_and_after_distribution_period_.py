...
if __name__ == "__main__":
	try:
		...
		#At end
		summary.user_block_status(node, accounts[0].name, ResourceResult(_balance="20.0000 PXBTS",_net_weight="917804007.8448 BEOS",_cpu_weight="917804007.8450 BEOS",_ram_bytes=15996145448))
		summary.user_block_status(node, accounts[1].name, ResourceResult(_balance="20.0000 PXBTS",_net_weight="917804007.8448 BEOS",_cpu_weight="917804007.8450 BEOS",_ram_bytes=15996155448))
