...
class jurisdiction_dictionary_object : public chainbase::object<jurisdiction_dictionary_object_type, jurisdiction_dictionary_object> {
   OBJECT_CTOR(jurisdiction_dictionary_object,(name)(description))
...
using jurisdiction_dictionary_index = chainbase::shared_multi_index_container<
   ...
   indexed_by<
      ...
      ordered_unique<tag<by_name_jurisdiction_dictionary>, BOOST_MULTI_INDEX_CONST_MEM_FUN(jurisdiction_dictionary_object, std::string, jurisdiction_dictionary_object::get_name)>
   >
>;
