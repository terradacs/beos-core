...
namespace eosio 
{
  namespace chain
  {
    class jurisdiction_producer_history_object : public chainbase::object<chain::jurisdiction_producer_history_object_type, jurisdiction_producer_history_object> 
    {
      OBJECT_CTOR(jurisdiction_producer_history_object)
    ...
    using jurisdiction_producer_history_index = chainbase::shared_multi_index_container<
      jurisdiction_producer_history_object,
      bmi::indexed_by<
        bmi::ordered_unique<
          bmi::tag<by_id>,
          bmi::member<jurisdiction_producer_history_object, jurisdiction_producer_history_object::id_type, &jurisdiction_producer_history_object::id>
        >,
        bmi::ordered_unique<
          bmi::tag<by_producer_name>,
          bmi::member<jurisdiction_producer_history_object, chain::account_name, &jurisdiction_producer_history_object::producer_name>
        >
      >
    >;
...
CHAINBASE_SET_INDEX_TYPE(eosio::chain::jurisdiction_producer_history_object, eosio::chain::jurisdiction_producer_history_index)
FC_REFLECT(eosio::chain::jurisdiction_producer_history_object, (producer_name))
